...
class RequestTest extends TestCase {
    ...
    public function testGetParameter() {
        $_SERVER = array(
            ...
            'REQUEST_URI' => 'test.com/param/20',
        );
        $request = new \Yeah\Fw\Http\Request();
        $this->assertEquals($request->getParameter('param'), 20);
        $this->assertNull($request->getParameter('param1'));
        $this->assertEquals($request->getUrlParameter('param'), 20);
        $this->assertNull($request->getUrlParameter('param1'));
    }
